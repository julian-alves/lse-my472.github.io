---
title: "MY472 - Week 2: Seminar exercises"
...
ipu_clean <- ip_and_unemployment %>%
  pivot_wider(names_from = series, values_from = value)  # long to wide
...
(_Optional_: Calculate the difference in each of unemployment rate and industrial production in the last two years of the sample. Where things improving again?)
